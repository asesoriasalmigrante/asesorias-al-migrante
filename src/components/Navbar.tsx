...
export const Navbar: React.FC<NavbarProps> = ({ onOpenBooking, onOpenReview, currentPage, onNavigateToPage }) => {
        ...
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden lg:flex items-center gap-6">
            ...
            <button
              ...
              className="px-4 py-2 border border-brand-accent/30 hover:border-brand-accent text-brand-accent hover:text-white hover:bg-brand-accent/5 rounded-lg text-xs font-semibold uppercase tracking-widest transition-all duration-300 cursor-pointer"
            >
              Dejar reseña
            </button>
        ...
        <div className="lg:hidden absolute top-full left-0 w-full bg-brand-blue border-b border-white/10 shadow-2xl">
          <nav className="px-4 pt-2 pb-6 space-y-3">
            ...
            <button
              ...
              className="w-full py-3 bg-white/5 hover:bg-white/10 border border-white/10 text-brand-accent hover:text-white rounded-xl text-sm font-semibold tracking-wide flex items-center justify-center gap-2 cursor-pointer transition-colors"
            >
              Dejar reseña / Calificarnos
            </button>
