...
// All local images are loaded and configured directly from /src/index.css
  ...
  const stepsDetail = [
    {
      ...
      icon: (
        <div
          className="w-full h-full custom-method-situacion-img scale-[1.45]"
          aria-label="Cuéntame tu situación"
        />
      ),
    ...
    },
    {
      ...
      icon: (
        <div
          className="w-full h-full custom-method-opciones-img scale-[1.45]"
          aria-label="Evaluamos tus opciones"
        />
      ),
    ...
    },
    {
      ...
      icon: (
        <div
          className="w-full h-full custom-method-estrategia-img scale-[1.45]"
          aria-label="Creamos tu plan de acción"
        />
      ),
    ...
    },
    {
      ...
      icon: (
        <div
          className="w-full h-full custom-method-acompanamiento-img scale-[1.45]"
          aria-label="Te acompaño en el proceso"
        />
      ),
