  ...
  const getIcon = (iconName: string) => {
    switch (iconName) {
      case 'plane':
        return (
          <div
            className="w-full h-full custom-service-migrar-img scale-[1.45]"
            aria-label="Quiero migrar"
          />
        );
      case 'folder':
        return (
          <div
            className="w-full h-full custom-service-proceso-img scale-[1.45]"
            aria-label="Ya inicié un proceso"
          />
        );
      case 'user':
        return (
          <div
            className="w-full h-full custom-service-orientacion-img scale-[1.45]"
            aria-label="Necesito orientación específica"
          />
        );
      default:
        return (
