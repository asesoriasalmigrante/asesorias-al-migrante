...
export const About: React.FC<AboutProps> = ({ onNavigateToDetail }) => {
  const values = [
    {
      icon: (
          ...
          <div className="lg:col-span-5 flex flex-col items-center">
            <div className="relative w-full max-w-sm">
              ...
              <div className="overflow-hidden rounded-3xl shadow-2xl aspect-[3/4] bg-white/[0.02] border border-white/10 relative">
                <div
                  className="w-full h-full custom-portrait-img grayscale-[20%] hover:grayscale-0 transition-all duration-500"
                  aria-label="Daniela Harrington - Abogada de Asesorías al Migrante"
                />
